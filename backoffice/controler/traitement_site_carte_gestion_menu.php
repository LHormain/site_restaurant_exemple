...
// récupération des données de la BDD 
    ...
    foreach ($menus as $donnees) {
        ...
        $table .= table_carte_gestion_menu($nom_entree, $nom_plat, $nom_dessert, $donnees['id_menu'], $donnees['afficher_menu'], $a_img_g, $a_img_d, $nom_img_g, $nom_img_d, $donnees['nom_menu'], $donnees['prix_menu']);
    }
?>