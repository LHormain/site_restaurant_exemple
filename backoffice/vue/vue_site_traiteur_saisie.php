<?php
include('controler/traitement_site_traiteur_saisie.php');
?>
<div class="col-12">
  <?php
  ...
  ?>
   <form action="#" method="post" enctype="multipart/form-data" class="row">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" name="nom_menu" id="nom_menu" aria-describedby="helpId6" placeholder="" value="<?php echo $nom_menu; ?>" required>
            <small id="helpId6" class="form-text text-muted">Entrer un nom atractif pour les clients</small>
        </div>
        <div class="mb-3">
