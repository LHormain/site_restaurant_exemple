function gestionAfficher(id_assiette, afficher_assiette) {
    ...
    xmlhttp.open("POST", "controler/requete_gestion_affichage_boisson.php", true); // il va chercher le fichier et l'ouvre
    ...
    xmlhttp.onload = function() { // peut aussi utiliser onreadystatechange ou autre chose
        ...
        let resultat = document.getElementById('aff'+id_assiette); // récupère le td contenant l'input
